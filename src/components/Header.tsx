      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <NavLink to="/admin" className={({isActive}) => isActive ? "text-yellow-200" : "hover:text-yellow-200 transition"}>Admin</NavLink>
          </nav>
        ...
        {isOpen && (
          <div className="md:hidden py-4">
            <div className="flex flex-col space-y-4">
              ...
              <NavLink to="/admin" className={({isActive}) => isActive ? "text-yellow-200" : "hover:text-yellow-200 transition"} onClick={() => setIsOpen(false)}>Admin</NavLink>
            </div>
          </div>
        )}
      </div>
